...
/**
 * TechDivision\Import\Cache\Repositories\Finders\CachedYieldedFinderFactory
 *
 * NOTICE OF LICENSE
 *
 ...
 */
namespace TechDivision\Import\Cache\Repositories\Finders;

use TechDivision\Import\Cache\CacheAdapterInterface;
use TechDivision\Import\Repositories\Finders\YieldedFinderFactory;
use TechDivision\Import\Repositories\FinderAwareRepositoryInterface;

/**
 * Factory for cached yielded finder instances.
 *
 * @author    Tim Wagner <t.wagner@techdivision.com>
 * @copyright 2021 TechDivision GmbH <info@techdivision.com>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 ...
 * @link      http://www.techdivision.com
 */
class CachedYieldedFinderFactory extends YieldedFinderFactory
{
    ...
    {
        return new CachedYieldedFinder(parent::createFinder($repository, $key), $this->getCacheAdapter());
    }
}
