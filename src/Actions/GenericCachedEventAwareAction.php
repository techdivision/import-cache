...
/**
 * TechDivision\Import\Cache\Actions\GenericCachedEventAwareAction
 *
 * NOTICE OF LICENSE
 *
...
class GenericCachedEventAwareAction extends GenericEventAwareAction implements CachedActionInterface
{
     ...
     * @param \TechDivision\Import\Actions\ActionInterface  $action    The action that has to be cached
