...
/**
 * TechDivision\Import\Cache\Actions\GenericCachedEventAwareIdentifierAction
 *
 * NOTICE OF LICENSE
 *
...
use TechDivision\Import\Actions\IdentifierActionInterface;
use TechDivision\Import\Actions\GenericEventAwareIdentifierAction;
...
class GenericCachedEventAwareIdentifierAction extends GenericEventAwareIdentifierAction implements CachedActionInterface
{
     ...
     *
     * @var \TechDivision\Import\Utils\CacheKeysInterface
     */
    protected $cacheKeys;
     ...
     * @param \TechDivision\Import\Actions\IdentifierActionInterface $action    The action that has to be cached
     * @param \TechDivision\Import\Utils\CacheKeysInterface          $cacheKeys The cache keys instance
     */
